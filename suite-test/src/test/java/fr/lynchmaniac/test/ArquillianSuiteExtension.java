...
/**
 * 
 * Le support du déploiement des suite de tests devrait ere pris en compte dans Arquillian 2.0
 * cf : https://issues.jboss.org/browse/ARQ-567
 * En attendant, nous pouvons créer notre propre extension pour prendre en compte le passage 
 * des suites de tests.
 * L'intéret étant de pouvoir ne pas démarrer/arrêter le serveur pour chaque classe de test.
 * On diminue ainsi le temps de passage des TU.
 * 
 */
